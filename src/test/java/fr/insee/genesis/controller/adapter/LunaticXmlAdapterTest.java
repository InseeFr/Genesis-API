...
class LunaticXmlAdapterTest {
    ...
    void test01() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit1, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
    ...
    void test05() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit2, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
        ...
        Optional<SurveyUnit> editedDTO = suDtos.stream().filter(surveyUnitDto ->
                surveyUnitDto.getState().equals(DataState.EDITED)
        ).findFirst();
    ...
    void test06() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit3, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
    ...
    void test07() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit4, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
        Assertions.assertThat(suDtos).hasSize(3);
        Assertions.assertThat(suDtos).filteredOn(surveyUnitDto ->
                surveyUnitDto.getState().equals(DataState.EDITED)
    ...
    void test08() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit5, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
    ...
    void test09() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit6, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
    ...
    void test10() {
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit7, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
    ...
    void test11(){
        // When
        List<SurveyUnit> suDtos = LunaticXmlAdapter.convert(lunaticXmlSurveyUnit8, metadataModel.getVariables(), ID_CAMPAIGN, Mode.WEB);
        // Then
        Assertions.assertThat(suDtos).hasSize(1);
